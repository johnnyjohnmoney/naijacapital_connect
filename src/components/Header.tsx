        ...
        <div className="hidden lg:flex lg:gap-x-12">
          {authenticatedNavigation.map((item) => (
            <Link
              key={item.name}
              href={item.href}
              className="text-sm font-semibold leading-6 text-gray-900 hover:text-green-600 relative"
            >
              {item.name}
                ...
                <div className="py-6">
                  {session ? (
                    ...
                    <>
                      ...
                      <Link
                        href="/auth/signup"
                        className="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-white bg-green-600 hover:bg-green-500 mt-2"
                        onClick={() => setMobileMenuOpen(false)}
                      >
                        Sign up
                      </Link>
